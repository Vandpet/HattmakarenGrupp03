...
namespace HattmakarenWebbAppGrupp03.Migrations
{
    ...
    [Migration("20260422141355_AddKN_NumberAndDescToHatTable")]
    partial class AddKN_NumberAndDescToHatTable
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("HattmakarenWebbAppGrupp03.Models.Hat", b =>
                {
                    ...
                    b.Property<string>("KN_Description")
                        .IsRequired()
                        .HasColumnType("nvarchar(max)");

                    b.Property<string>("KN_Number")
                        .IsRequired()
                        .HasColumnType("nvarchar(max)");
